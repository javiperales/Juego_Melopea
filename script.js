function genQuote() {
    var randNum = Math.floor(Math.random() * 277) + 1;
    document.getElementById("quote").innerHTML = quotes[randNum];
  }
  
  //listado de frases
  var quotes = [
    "Yo nunca he escrito a mi ex una noche de fiesta",
    "Yo nunca he fingido estar en un videoclip cuando salgo de la ducha mientras pongo caras intensas en el espejo",
    "Yo nunca he hecho un spoiler de Juego de Tronos",
    "Yo nunca he hecho pis en una piscina con miedo por si aparecía el circulo rojo",
    "Yo nunca he fingido que me llamaban para escapar de una cita",
    "Yo nunca he estado más de tres días sin ducharme",
    "Yo nunca me he apuntado al gimnasio pero no he ido jamás",
    "Yo nunca he stalkeado el instagram del el/la ex de mi novi@",
    "Yo nunca me he dado el pisto en una entrevista de trabajo",
    "Yo nunca he cantado en el Singstar “Cuando zarpa el amor” de Camela",
    "Yo nunca he apuntado con la linterna mi boca para enseñarle las placas a un amigo",
    "Yo nunca he abierto a la policía por haber hecho un fiestón en casa",
    "Yo nunca me he imaginado siendo del sexo opuesto",
    "Yo nunca he llamado mamá a mi profesora",
    "Yo nunca me he pasado mi parada del bus volviendo de fiesta y he acabao en otra parte",
    "Yo nunca he  perdido un movil",
    "Yo nunca he llevado unas gafas de cristal solo por posturear",
    "Yo nunca me autoavergüenzo de haber sido fan de Crepúsculo",
    "he pesado la fruta, le he pegado el ticket y luego he metido más",
    "Yo nunca mentí en el Yo Nunca",
    "Yo nunca he estornudado y me ha salido un moco",
    "Yo nunca he preguntado a alguien que no trabajaba en una tienda si tenía mi talla",
    "Yo nunca he confundido a una persona con un camarero en un restaurante",
    "Yo nunca he indicado mal un camino cuando me han preguntado",
    "Yo nunca he olido mi propio pedo",
    "Yo nunca he fingido un desmayo para darle dramatismo a una situación",
    "Yo nunca he intentado mover cosas con la mente (sin resultado)",
    "Vhe flirteado con el novio de un amig@",
    "Yo nunca he cotilleado a quién daba like mis exparejas",
    "Yo nunca he mirado el papel después de ir al baño",
    "Yo nunca he acosado por redes sociales a mi artista favorito",
    "Yo nunca me he creído Mr Robot al instalar un programa pirata",
    "Yo nunca he mandado un audio subidito de tono a mi madre por error",
    ...
    "Yo nunca  me he acostado con el/la ex de un amigo",
    ...
    "Yo nunca me he tomado la pastilla del dia despues.",
    ...
    "A mi nunca me han lamido el culo.",
    ...
    "Yo nunca he fingido o exagerado un orgasmo.",
    ...
    "A mi nunca se me han acabado encima del cuerpo.",
    ...
    "Yo nunca lo he hecho con mis padres cerca.",
    ...
    "Yo nunca he sido complice de cuernos.",
    ...
    "Yo nunca me he/a mi nunca me han despertado con una mamada/polvo.",
    ...
    "Yo nunca he estado frustrado porque no me satisfacia el sexo con una persona a quien quería.",
    ...
    "Yo nunca he tenia la paranoia de estar embarazada porque se me habia retrasado la regla.",
    ...
    "Yo nunca me he tirado/liado a alguien que no he vuelto a ver en mi vida.",
    "Yo nunca me he imaginado como serian las tetas/el pene de alguien presente.",
    "Yo nunca he estado pillado por alguien presente sin haberselo dicho nunca.",
    "Yo nunca he creido que X e Y (presentes) se podrian liar. (Muchas combinaciones)",
    "Sigue esta lista en Spotify  JavieRegueton",
    "Bebe si piensas que este juego y su creador mola"
  ];
